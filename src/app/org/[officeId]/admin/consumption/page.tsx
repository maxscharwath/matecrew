...
export default async function ConsumptionPage({ params, searchParams }: Props) {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div>
        <h1 className="text-2xl font-bold">{t("bulkConsumption.title")}</h1>
        <p className="mt-1 text-muted-foreground">
          {t("bulkConsumption.subtitle")}
        </p>
      </div>
